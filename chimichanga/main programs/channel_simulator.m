...
hmat2=hmat.'; 
[lenGtilde,~]=size(hmat2);
Gtilde=zeros(lenGtilde,1);
for countt= 1:lenGtilde;
...
file_name = '/Users/graceflores/Documents/MATLAB/ncmns_git/chimichanga/results/hello';
save(file_name, 'hmat', 'dt', 'df', '-mat')
