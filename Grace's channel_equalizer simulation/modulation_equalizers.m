...
% Linear Equalizer
subplot(1,2,1);
plot(abs(errLE(1:1000)),'LineWidth',3)
title('LE Error Signal','FontSize',20)
xlabel('Symbols','FontSize',20)
ylabel('Error Magnitude','FontSize',20)


% Decision Feedback Equalizer 
subplot(1,2,2);
plot(abs(errDFE(1:1000)),'LineWidth',3)
title('DFE Error Signal','FontSize',20)
xlabel('Symbols','FontSize',20)
ylabel('Error Magnitude','FontSize',20)
